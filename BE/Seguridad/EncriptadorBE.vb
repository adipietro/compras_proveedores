...
Public Class EncriptadorBE
#Region "Singleton"
    Private Shared mInstance As EncriptadorBE = Nothing

    Private Sub New()

    End Sub

    Public Shared Function GetInstance() As EncriptadorBE
        If mInstance Is Nothing Then
            mInstance = New EncriptadorBE
        End If
        Return mInstance
    End Function
#End Region
